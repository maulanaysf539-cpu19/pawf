...
<body>
    ...
    <!-- create post -->
    <div class="container">
        <!-- TAMBAHKAN enctype="multipart/form-data" supaya bisa kirim file -->
        <form action="" method="post" id="text-editor" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                <label for="post_image">Thumbnail Image</label>
                <input type="file" name="post_image" class="form-control" accept="image/*">
                <small class="text-muted">Pilih gambar untuk cover postingan kamu.</small>
            </div>
